        ...
        if (squares_clicked[i] == 1 || touching_number(i)) {
            ...
            if (r == 0) {
                ...
                switch (where[i]) {
                    case "topleft":
                        if (r == 3) {
                            if (document.images[i + 1].src != "http://googledrive.com/host/0B6xHs0uhsCQzflprNjFlc1l3VXlQTmpCV2JBTWw3bHZ3dlRoMnFoX3ZhUW5SNnI0cUtTSFk/flag.svg")
                            { rightclick(i + 1); squares_clicked[i + 1] = 1; }
                            if (document.images[i + 16].src != "http://googledrive.com/host/0B6xHs0uhsCQzflprNjFlc1l3VXlQTmpCV2JBTWw3bHZ3dlRoMnFoX3ZhUW5SNnI0cUtTSFk/flag.svg")
                            { rightclick(i + 16); squares_clicked[i + 16] = 1; }
                            if (document.images[i + 17].src != "http://googledrive.com/host/0B6xHs0uhsCQzflprNjFlc1l3VXlQTmpCV2JBTWw3bHZ3dlRoMnFoX3ZhUW5SNnI0cUtTSFk/flag.svg")
                    ...
                    case "topright":
                        if (r == 3) {
                            ...
                            if (document.images[i + 16].src != "http://googledrive.com/host/0B6xHs0uhsCQzflprNjFlc1l3VXlQTmpCV2JBTWw3bHZ3dlRoMnFoX3ZhUW5SNnI0cUtTSFk/flag.svg")
                            { rightclick(i + 16); squares_clicked[i + 16] = 1; }
                            if (document.images[i + 15].src != "http://googledrive.com/host/0B6xHs0uhsCQzflprNjFlc1l3VXlQTmpCV2JBTWw3bHZ3dlRoMnFoX3ZhUW5SNnI0cUtTSFk/flag.svg")
...
function S1(p) {
    ...
    while (gameover == false) {
        ...
        if (numflags == (num_mines - 1)) {
            ...
            var tile2 = 0;
            for (var i = 0; i < 256; i++) {
                if ((visib[i] == "tile") && (document.images[i] != "http://googledrive.com/host/0B6xHs0uhsCQzflprNjFlc1l3VXlQTmpCV2JBTWw3bHZ3dlRoMnFoX3ZhUW5SNnI0cUtTSFk/flag.svg")) {
                    tile1++;
                    tile2 = i;
                }
            }
